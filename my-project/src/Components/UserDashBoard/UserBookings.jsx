                    ...
                    <div className="mt-4 pt-4 border-t border-slate-100 flex flex-wrap items-center gap-2">
                      ...
                      {normalizedPaymentStatus === 'BOOKING_CONFIRMED' && (
                        <button
                          ...
                          className="px-3 py-1.5 border border-violet-200 bg-violet-50 text-violet-700 rounded-lg text-sm font-medium hover:bg-violet-100 transition-colors flex items-center gap-1.5"
                        >
